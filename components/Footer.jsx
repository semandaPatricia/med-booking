...
function Footer() {
  ...
  <div className="mx-auto max-w-5xl px-4 py-16 sm:px-6 lg:px-8">
    ...
    <Image src={'/logoipsum.svg'} width={200} height={200} alt="logo"/>
        </div>
    </div>

    <p className="mx-auto mt-6 max-w-md text-center leading-relaxed text-gray-500">
    Access video consultation with the countrys top doctors on the BookMyDoctor Website. Connect with doctors online, available 24/7, from the comfort of your home.
    </p>
